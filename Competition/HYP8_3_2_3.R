...
HYP8_3_2_3_Model = cv.glmnet(x,y=as.factor(DataTrain[,c("Popular")]), type.measure="auc" ,family="binomial")

#HYP8_3_2_3_predictions = predict(HYP8_3_2_3_Model, newx=x[,1],s=c(0.001,0.003), type="response")
HYP8_3_2_3_predictions = predict(HYP8_3_2_3_Model, newx=x,s="lambda.min", type="response")
#table(y[,1],HYP8_3_2_3_predictions[,1] >0.5)
HYP8_3_2_3_ROCRpred = prediction(HYP8_3_2_3_predictions[,1], y[,1])
HYP8_3_2_3_ROCRperf = performance(HYP8_3_2_3_ROCRpred, "tpr", "fpr")
plot(HYP8_3_2_3_ROCRperf, colorize=TRUE, print.cutoffs.at=seq(0,1,0.1), text.adj=c(-0.2,1.7))
HYP8_3_2_3_AUC = as.numeric(performance(HYP8_3_2_3_ROCRpred, "auc")@y.values)
HYP8_3_2_3_AUC
...
HYP8_3_2_3_TestPredictions = predict(HYP8_3_2_3_Model, newx=xTest,s="lambda.min", type="response")
HYP8_3_2_3_Submission = data.frame(UniqueID = NewsTest$UniqueID, Probability1 = HYP8_3_2_3_TestPredictions[,1])
write.csv(HYP8_3_2_3_Submission, "HYP8_3_2_3_Submission.csv", row.names=FALSE)
