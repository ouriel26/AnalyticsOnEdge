...
HYP8_3_2_3_1_Model = randomForest(Popular ~ . -herald -tribun -two -archiv -unit -photo -work -world, data=DataTrain, ntree = 200, nodesize=25)


#HYP8_3_2_3_1_predictions = predict(HYP8_3_2_3_1_Model, newx=x[,1],s=c(0.001,0.003), type="response")
HYP8_3_2_3_1_predictions = predict(HYP8_3_2_3_1_Model, type="response")
#table(y[,1],HYP8_3_2_3_1_predictions[,1] >0.5)
HYP8_3_2_3_1_ROCRpred = prediction(HYP8_3_2_3_1_predictions, DataTrain$Popular)
HYP8_3_2_3_1_ROCRperf = performance(HYP8_3_2_3_1_ROCRpred, "tpr", "fpr")
plot(HYP8_3_2_3_1_ROCRperf, colorize=TRUE, print.cutoffs.at=seq(0,1,0.1), text.adj=c(-0.2,1.7))
HYP8_3_2_3_1_AUC = as.numeric(performance(HYP8_3_2_3_1_ROCRpred, "auc")@y.values)
HYP8_3_2_3_1_AUC

HYP8_3_2_3_1_TestPredictions = predict(HYP8_3_2_3_1_Model, newdata=DataTest, type="response")
HYP8_3_2_3_1_Submission = data.frame(UniqueID = NewsTest$UniqueID, Probability1 =round(HYP8_3_2_3_1_TestPredictions, digits=6))
write.csv(HYP8_3_2_3_1_Submission, "HYP8_3_2_3_1_Submission.csv", row.names=FALSE)
